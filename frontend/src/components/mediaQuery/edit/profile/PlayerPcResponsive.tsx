...
export const PlayerPcResponsive: VFC<Props> = memo((props) => {
  ...
  return (
    <EditProfileWrapper>
      ...
      <EditProfileContainer>
        ...
        <SubmitButton onClick={onClickPostProfile} disabled={name || age || gender || prefecture || tall || introduction || avatar ? false : true}>保存</SubmitButton>
      </EditProfileContainer>
    </EditProfileWrapper>
  )
})
